namespace RobloxRuntime
{
    public static partial class Globals
    {
        public static class math
        {
            ...
            public static (float, float) frexp(float x)
            {
                return default;
            }

            /// <summary>Returns x*2^e (e should be an integer).</summary>
            public static float ldexp(float x, float e)
            {
                return default;
            }
            ...
            public static void randomseed(float x)
            {
            }
